...
class SimulationConfig(BaseModel):
    ...
    D: float = 85.4                         # N/m           - Spring constant
    J: float = 1 / 3 * 0.156 * 0.346 ** 2   # kg*m^2        - Moment of inertia of the catapult arm
    m_cup: float = 0.027                    # kg            - Cup mass
    m_ball: float = 0.00267                 # kg            - Ball mass
